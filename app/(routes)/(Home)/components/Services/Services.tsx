      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="relative bg-img-developer bg-cover grayscale rounded-md h-full lg:col-span-2 p-6 aspect-square lg:aspect-auto flex justify-between flex-col cursor-pointer hover:scale-95 transition-all duration-500">
              {/* Overlay */}
              ...
              <div className="relative z-10 flex justify-between flex-col h-full">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-slate-400 max-w-xs text-base font-bold">
                    Desarrollamos sitios web modernos, optimizados y adaptables
                    a cualquier dispositivo para ofrecer la mejor experiencia de
            ...
            {/* Card 2 */}
            <div className="relative bg-img-productions bg-cover grayscale rounded-md aspect-square p-6 flex justify-between flex-col cursor-pointer hover:scale-95 transition-all duration-500">
              {/* Overlay */}
